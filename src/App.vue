        ...
        <v-col class="col-4">
          <v-container fluid="">
            <v-row justify="center">
              <v-img :src="require('@/icon_image.png')" max-width="250">
              </v-img>
            </v-row>
            <v-row justify="center">
              <p class="display-1 mt-4">Naoto</p>
            </v-row>
            <v-row class="">
              <v-col class="col-2">
              </v-col>
          ...
          <v-row>
            ...
            <v-col>
              <v-row no-gutters class="pb-8">
                <v-col class="col-11">
                  <v-card class="pt-4 pb-1 pr-4 pl-4" outlined tile color="#cfe2f3">
              ...
              <v-row no-gutters class="pb-8">
                <v-col class="col-11">
                  <v-card class="pt-4 pb-1 pr-4 pl-4" outlined tile color="#ead1dc">
              ...
              <v-row no-gutters>
                <v-col class="col-11">
                  <v-card class="pt-4 pb-1 pr-4 pl-4" outlined tile color="#f5e4bf">
